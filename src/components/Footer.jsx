        ...
        <div className="container max-w-screen-xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row justify-between gap-20">
            ...
            <div className="text-left mb-3 lg:mb-0">
              ...
              <a
                href="#"
                className="block font-light text-gray-400 text-xl my-3 hover:text-gray-800 transition ease-in-out duration-300"
              >
                Home
              </a>
              ...
              <a
                href="/services"
                className="block font-light text-gray-400 text-xl  hover:text-gray-800 transition ease-in-out duration-300"
              >
                Features
              </a>
