            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
              <a href='javascript:;' className='max-w-[384px] mx-auto'>
                <div className='w-full relative max-w-sm aspect-square'>
                  ...
                  <Image src={Simg3} alt='image' className='h-[400px] rounded-xl' />
                </div>
              </a>
              ...
              <a href='javascript:;' className='max-w-[384px] mx-auto'>
                <div className='w-full relative max-w-sm aspect-square'>
                  ...
                  <div className='bg-black absolute bottom-0 h-20 rounded-b-xl w-full opacity-25 z-10'></div>
                  <Image src={Simg1} alt='image' className='h-[400px] rounded-xl' />
                </div>
              </a>
          ...
          <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative'>
            <div className='grid grid-cols-1 lg:grid-cols-2 lg:gap-9'>
              <div className='lg:pr-24 flex items-center'>
                <div className='data w-full'>
                  ...
                  {item.map((item) => (
                    <li
                      key={item.id}
                      className='flex gap-3  tracking-wider  text-[16px] leading-6  text-gray-500 max-lg:text-center max-w-2xl mx-auto'
                    >
                      {item.name}
                    </li>
                  ))}
              ...
              <div className='img-box'>
                <Image src={Hero} alt='image' className='hidden lg:block rounded-xl' />
              </div>
            </div>
          </div>
        </section>
              ...
              <div className='w-full max-lg:max-w-2xl mx-auto lg:mx-0 lg:w-1/3 bg-white p-6 rounded-2xl shadow-md shadow-gray-100'>
                <div className='flex gap-5'>
                  ...
                  <div className='flex-1'>
                    <h4 className='text-xl text-gray-900 font-semibold mb-2'>Company growth</h4>
                    <p className='text-xs text-gray-500 leading-5'>
                      Our very talented team members are the powerhouse of pagedone and pillars of
                      our success.
                    </p>
                  </div>
                </div>
              ...
              <div className='w-full max-lg:max-w-2xl mx-auto lg:mx-0 lg:w-1/3 bg-white p-6 rounded-2xl shadow-md shadow-gray-100'>
                <div className='flex gap-5'>
                  ...
                  <div className='flex-1'>
                    ...
                    <p className='text-xs text-gray-500 leading-5'>
                      We have accomplished more than 625 projects worldwide and we are still
                      counting many more.
                    </p>
                  </div>
                </div>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-14'>
              ...
              >
                <div className='bg-[#0000006c] px-5 py-3 '>
                  ...
                  <p className='text-base font-normal text-white/70'>
                    where knowledge meets innovation, and success is sculpted through a blend of
                    skill and vision.
                  </p>
                </div>
              </div>
              ...
              >
                <div className='bg-[#0000006c] px-5 py-3 '>
                  ...
                  <p className='text-base font-normal text-white/70'>
                    Crafting exceptional interiors, where aesthetics meet functionality for spaces
